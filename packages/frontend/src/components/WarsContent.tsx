...
import { columns } from "./WarsContent/columns";
import { ExpandedRowContent } from "./WarsContent/ExpandedRowContent";
  ...
  return (
    <div className="container mx-auto px-4 py-4 max-w-7xl">
      <div className="mb-4 sm:mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Ranking de Guerras</h1>
        <p className="text-xs sm:text-sm text-muted-foreground">
          Classificação dos melhores jogadores nas últimas guerras
        </p>
      </div>
      ...
      {isLoading ? (
          ...
          <CardContent className="p-2 sm:p-6">
            <DataTable
              ...
              data={ranking.map((player) => ({
                ...player,
                renderExpandedContent: (player: PlayerStats) => (
        ...
        <Card className="border-2 text-center">
          <CardContent className="p-8 sm:p-12">
            <p className="text-xs sm:text-sm text-muted-foreground">
              Nenhum dado encontrado para os meses selecionados.
            </p>
          </CardContent>
        </Card>
      ) : (
        <Card className="border-2 text-center">
          <CardContent className="p-8 sm:p-12">
            <p className="text-xs sm:text-sm text-muted-foreground">
              Selecione pelo menos um mês para visualizar o ranking.
            </p>
          </CardContent>
        </Card>
      )}
