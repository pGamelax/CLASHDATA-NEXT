...
import { z } from "zod";
import { Lock, Mail, Loader2, XCircle, Eye, EyeOff, Shield, Trophy, TrendingUp } from "lucide-react";
  ...
  async function handleSignIn({ email, password }: SignInSchema) {
    ...
    await authClient.signIn.email(
      { email, password },
      {
        ...
        onError: (ctx) => setServerError(ctx.error.message || "Erro ao fazer login"),
      }
    );
  }
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-background">
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit(handleSignIn)} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      errors.email ? "border-destructive/60 bg-destructive/5 focus-visible:ring-destructive/30" : "border-border focus-visible:ring-primary/30"
                    )}
                  />
                </div>
                {errors.email && (
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      errors.password ? "border-destructive/60 bg-destructive/5 focus-visible:ring-destructive/30" : "border-border focus-visible:ring-primary/30"
                    )}
                  />
                  <button
                    type="button"
              ...
              >
                {isSubmitting ? <><Loader2 className="h-4 w-4 animate-spin mr-2" />Entrando...</> : "Entrar"}
              </Button>
            </form>
