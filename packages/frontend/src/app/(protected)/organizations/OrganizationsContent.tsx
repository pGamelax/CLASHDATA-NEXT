...
import { Shield, Plus, ArrowRight, Building2 } from "lucide-react";
...
export function OrganizationsContent({ organizations }: Props) {
  return (
          ...
          <Card className="border-2 border-dashed bg-gradient-to-br from-muted/40 to-muted/20">
            <CardContent className="flex flex-col items-center justify-center py-20">
              ...
              <p className="mb-8 text-center text-muted-foreground max-w-md">
                Comece criando sua primeira organização para gerenciar seus clãs e acompanhar suas
                estatísticas.
              </p>
              <Button
                asChild
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <CardTitle className="truncate text-lg font-bold group-hover:text-primary transition-colors">
                          {org.name}
                        </CardTitle>
                    ...
                    {org.clans.length > 0 && (
                      <div className="flex items-center gap-2 text-sm text-muted-foreground p-3 rounded-lg bg-muted/60 border border-border/50">
                        ...
                        <span className="font-semibold">
                          {org.clans.length} {org.clans.length === 1 ? "clã" : "clãs"}
                        </span>
                      </div>
                    )}
